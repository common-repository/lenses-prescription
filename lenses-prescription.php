<?php
/**
 * Plugin Name: Lenses Prescription
 * Description: Displays product options as table for contact lenses prescription.
 * Version: 1.0.0
 * Author: Pektsekye
 ...
 * Tested up to: 6.4.3
 *
 * Text Domain: lenses-prescription
 *
 * WC requires at least: 3.0
 * WC tested up to: 8.6.1
 * 
 * @package LensesPrescription
 * @author Pektsekye
 */
if (!defined('ABSPATH')) exit;

final class Pektsekye_LensesPrescription {
  ...
  private function init_hooks(){ 
    new Pektsekye_LensesPrescription_Model_Observer();           
  }    
  ...
  private function init_controllers(){
      ...
      new Pektsekye_LensesPrescription_Controller_Product();    	
      ...
      if ((isset($_GET['post']) && isset($_GET['action']) && $_GET['action'] == 'edit') || ('post-new.php' == $pagenow && isset($_GET['post_type']) && $_GET['post_type'] == 'product')){         
        ...
        new Pektsekye_LensesPrescription_Controller_Adminhtml_Product();                    
      }                
    }     	  
  }  
...
function Pektsekye_LP(){
	return Pektsekye_LensesPrescription::instance();
}

include_once('Setup/Install.php');  
register_activation_hook(__FILE__, array('Pektsekye_LensesPrescription_Setup_Install', 'install'));
